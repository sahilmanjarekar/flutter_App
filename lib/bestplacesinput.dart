...
class bestplacesinputpage extends StatefulWidget {
  @override
  _AddTourPlacePageState createState() => _AddTourPlacePageState();
}

class _AddTourPlacePageState extends State<bestplacesinputpage> {
  ...
  void submitData() async {
    if (_formKey.currentState!.validate()) {
      ...
      await FirebaseFirestore.instance.collection('bestplace').add({
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('best place added successfully')));
      _clearFormFields();
    }
  }
