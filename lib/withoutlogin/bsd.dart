...
class bpp extends StatefulWidget {
  final String spotId;

  bpp({Key? key, required this.spotId, required String documentId})
      : super(key: key);
...
class _SpotPageState extends State<bpp> {
  ...
  void sfds() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Feedback'),
          content: Text('To give feedback, you need to login first.'),
          actions: <Widget>[
            TextButton(
              child: Text('Login'),
              onPressed: () {
