...
import 'package:final_project/withoutlogin/bsd.dart';
import 'package:final_project/withoutlogin/hbb.dart';
import 'package:final_project/withoutlogin/input.dart';
import 'package:final_project/withoutlogin/spotdetails.dart';
import 'package:flutter/material.dart';

void main() => runApp(MaterialApp(home: asp()));

class asp extends StatefulWidget {
  _AllSpotsPageState createState() => _AllSpotsPageState();
}

class _AllSpotsPageState extends State<asp> {
  String searchQuery = '';
  ...
  Stream<QuerySnapshot> get placesStream {
    ...
    if (searchQuery.isNotEmpty) {
      // Assuming 'placeAddress' is the field to search by and it's all lowercase for consistent searching.
      return collection
          .where('placeAddress', isEqualTo: searchQuery)
          .snapshots();
    }
    ...
    return Scaffold(
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  shrinkWrap:
                      true, // Use this to fit the list in the SingleChildScrollView
                  itemCount: snapshot.data!.docs.length,
                  itemBuilder: (context, index) {
                    DocumentSnapshot doc = snapshot.data!.docs[index];
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Color.fromARGB(
            255, 9, 25, 23), // Use a color that fits your app theme
